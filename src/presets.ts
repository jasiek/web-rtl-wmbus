...
export const PRESETS: WmbusPreset[] = [
  {
    ...
    demod: { kind: "wmbus868", centerHz: 868_950_000, decimation: 2, simultaneous: false },
    supported: true,
    countries: EU_868,
  },
  {
    ...
    sampleRate: 1_600_000,
    demod: { kind: "wmbus868", centerHz: 868_300_000, decimation: 2, simultaneous: false },
    supported: true,
    countries: EU_868,
  },
  {
    ...
    demod: { kind: "wmbus868", centerHz: 868_625_000, decimation: 3, simultaneous: true },
    supported: true,
    countries: EU_868,
  },
  {
  ...
  },
  {
    ...
    sampleRate: 1_600_000,
    demod: { kind: "wmbus868", centerHz: 433_820_000, decimation: 2, simultaneous: false },
    supported: false,
